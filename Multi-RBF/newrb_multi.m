function [out1,out2] = newrb_multi(varargin)
...
function [net,tr] = create_network(param)
  ...
  % TODO: repeat the designrb() process and see if I can add another layer
  % by that. 
  
  net = newrb(p, t, param.goal, param.spread, mn, param.displayFreq);
  trained_1 = net(p);
  % get prediction error
  
  
  [w1,b1,w2,b2,tr] = designrb(p,t, param.goal, );
  warning(warn1.state,warn1.identifier);
  warning(warn2.state,warn2.identifier);
